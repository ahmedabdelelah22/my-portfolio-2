  ...
  return (
    <section id="education" className="section py-20" ref={ref}>
      ...
      <div className="max-w-2xl mb-16">
        ...
        <h2
          className={`section-title fade-up delay-1 ${inView ? "in-view" : ""}`}
        >
      ...
      {/* Education Timeline */}
      <div
        className={`space-y-8 mb-16 fade-up delay-2 ${inView ? "in-view" : ""}`}
      >
        {/* Timeline line */}
          ...
          <div className="space-y-8">
            {education.map((item, i) => (
              <div key={item.degree} className="relative sm:pl-20">
                {/* Timeline dot */}
                <div className="sm:absolute left-0 top-0 sm:transform sm:transition-all sm:duration-300 sm:hover:translate-y-10 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white shadow-lg mb-2">
                  {" "}
                  <GraduationCap size={24} />
                </div>

                {/* Card */}
                <div className="link-underline p-6 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-400 transition-all">
